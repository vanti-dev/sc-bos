...
// Add extends Router.Add to panic if client is not of type rpc.AxiomXaDriverServiceClient.
func (r *AxiomXaDriverServiceRouter) Add(name string, client interface{}) interface{} {
	if !r.HoldsType(client) {
		panic(fmt.Sprintf("not correct type: client of type %T is not a rpc.AxiomXaDriverServiceClient", client))
	}
	return r.Router.Add(name, client)
}

func (r *AxiomXaDriverServiceRouter) HoldsType(client interface{}) bool {
