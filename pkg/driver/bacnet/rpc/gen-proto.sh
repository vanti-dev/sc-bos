...
if [ -d ../../../../pkg/trait/rpc ]; then
  sed -i.bak '/rpc "github.com\/vanti-dev\/sc-bos\/pkg\/driver\/bacnet\/rpc"/d' ../../../../pkg/trait/rpc/*.pb.go
...
if [ -d ../../../../pkg/trait/rpcpb ]; then
  sed -i.bak '/rpc "github.com\/vanti-dev\/sc-bos\/pkg\/driver\/bacnet\/rpc"/d' ../../../../pkg/trait/rpcpb/*.pb.go
