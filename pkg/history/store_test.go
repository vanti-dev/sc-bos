...
func TestRecord_CompareFrom(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.a.CompareFrom(tt.b); got != tt.want {
				t.Errorf("CompareFrom() = %v, want %v", got, tt.want)
			}
		})
	}
}
...
func TestRecord_CompareTo(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if got := tt.a.CompareTo(tt.b); got != tt.want {
...
func TestIntersectRecords(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			if gf, gt := IntersectRecords(tt.f1, tt.t1, tt.f2, tt.t2); gf.CompareFrom(tt.wf) != 0 || gt.CompareTo(tt.wt) != 0 {
				t.Errorf("IntersectRecords() = %v,%v, want %v,%v", gf, gt, tt.wf, tt.wt)
			}
			// same again but testing commutativity
			if gf, gt := IntersectRecords(tt.f2, tt.t2, tt.f1, tt.t1); gf.CompareFrom(tt.wf) != 0 || gt.CompareTo(tt.wt) != 0 {
				t.Errorf("IntersectRecords() = %v,%v, want %v,%v", gf, gt, tt.wf, tt.wt)
			}
		})
	}
