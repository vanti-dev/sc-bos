...
const file_devices_proto_rawDesc = "" +
	"\n" +
	"\rdevices.proto\x12\rsmartcore.bos\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x15traits/metadata.proto\x1a\x12types/change.proto\x1a\x17types/time/period.proto\x1a\fhealth.proto\"\xe7\t\n" +
	"\x06Device\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x126\n" +
	"\bmetadata\x18\x02 \x01(\v2\x1a.smartcore.traits.MetadataR\bmetadata\x12?\n" +
	"\rhealth_checks\x18\x03 \x03(\v2\x1a.smartcore.bos.HealthCheckR\fhealthChecks\x1a\xcf\b\n" +
	"\x05Query\x12E\n" +
	"\n" +
	...
	"\bincludes\x18\x03 \x01(\v2&.smartcore.bos.DevicesMetadata.IncludeR\bincludes\"\xbc\x01\n" +
	"\x1aPullDevicesMetadataRequest\x127\n" +
	"\tread_mask\x18\x02 \x01(\v2\x1a.google.protobuf.FieldMaskR\breadMask\x12B\n" +
	"\bincludes\x18\x03 \x01(\v2&.smartcore.bos.DevicesMetadata.IncludeR\bincludes\x12!\n" +
	"\fupdates_only\x18\x04 \x01(\bR\vupdatesOnly\"\x91\x02\n" +
...
var file_devices_proto_depIdxs = []int32{
	...
	23, // 11: smartcore.bos.PullDevicesMetadataRequest.read_mask:type_name -> google.protobuf.FieldMask
	15, // 12: smartcore.bos.PullDevicesMetadataRequest.includes:type_name -> smartcore.bos.DevicesMetadata.Include
	18, // 13: smartcore.bos.PullDevicesMetadataResponse.changes:type_name -> smartcore.bos.PullDevicesMetadataResponse.Change
	11, // 14: smartcore.bos.GetDownloadDevicesUrlRequest.query:type_name -> smartcore.bos.Device.Query
	24, // 15: smartcore.bos.GetDownloadDevicesUrlRequest.history:type_name -> smartcore.types.time.Period
	19, // 16: smartcore.bos.GetDownloadDevicesUrlRequest.table:type_name -> smartcore.bos.GetDownloadDevicesUrlRequest.Table
	25, // 17: smartcore.bos.DownloadDevicesUrl.expire_after_time:type_name -> google.protobuf.Timestamp
	12, // 18: smartcore.bos.Device.Query.conditions:type_name -> smartcore.bos.Device.Query.Condition
	13, // 19: smartcore.bos.Device.Query.Condition.string_in:type_name -> smartcore.bos.Device.Query.StringList
	13, // 20: smartcore.bos.Device.Query.Condition.string_in_fold:type_name -> smartcore.bos.Device.Query.StringList
	25, // 21: smartcore.bos.Device.Query.Condition.timestamp_equal:type_name -> google.protobuf.Timestamp
	25, // 22: smartcore.bos.Device.Query.Condition.timestamp_gt:type_name -> google.protobuf.Timestamp
	25, // 23: smartcore.bos.Device.Query.Condition.timestamp_gte:type_name -> google.protobuf.Timestamp
	25, // 24: smartcore.bos.Device.Query.Condition.timestamp_lt:type_name -> google.protobuf.Timestamp
	25, // 25: smartcore.bos.Device.Query.Condition.timestamp_lte:type_name -> google.protobuf.Timestamp
	13, // 26: smartcore.bos.Device.Query.Condition.name_descendant_in:type_name -> smartcore.bos.Device.Query.StringList
	13, // 27: smartcore.bos.Device.Query.Condition.name_descendant_inc_in:type_name -> smartcore.bos.Device.Query.StringList
	16, // 28: smartcore.bos.DevicesMetadata.StringFieldCount.counts:type_name -> smartcore.bos.DevicesMetadata.StringFieldCount.CountsEntry
	26, // 29: smartcore.bos.PullDevicesResponse.Change.type:type_name -> smartcore.types.ChangeType
	0,  // 30: smartcore.bos.PullDevicesResponse.Change.new_value:type_name -> smartcore.bos.Device
	0,  // 31: smartcore.bos.PullDevicesResponse.Change.old_value:type_name -> smartcore.bos.Device
	25, // 32: smartcore.bos.PullDevicesResponse.Change.change_time:type_name -> google.protobuf.Timestamp
	1,  // 33: smartcore.bos.PullDevicesMetadataResponse.Change.devices_metadata:type_name -> smartcore.bos.DevicesMetadata
	25, // 34: smartcore.bos.PullDevicesMetadataResponse.Change.change_time:type_name -> google.protobuf.Timestamp
	20, // 35: smartcore.bos.GetDownloadDevicesUrlRequest.Table.include_cols:type_name -> smartcore.bos.GetDownloadDevicesUrlRequest.Table.Column
	20, // 36: smartcore.bos.GetDownloadDevicesUrlRequest.Table.exclude_cols:type_name -> smartcore.bos.GetDownloadDevicesUrlRequest.Table.Column
	2,  // 37: smartcore.bos.DevicesApi.ListDevices:input_type -> smartcore.bos.ListDevicesRequest
	4,  // 38: smartcore.bos.DevicesApi.PullDevices:input_type -> smartcore.bos.PullDevicesRequest
	6,  // 39: smartcore.bos.DevicesApi.GetDevicesMetadata:input_type -> smartcore.bos.GetDevicesMetadataRequest
	7,  // 40: smartcore.bos.DevicesApi.PullDevicesMetadata:input_type -> smartcore.bos.PullDevicesMetadataRequest
	9,  // 41: smartcore.bos.DevicesApi.GetDownloadDevicesUrl:input_type -> smartcore.bos.GetDownloadDevicesUrlRequest
	3,  // 42: smartcore.bos.DevicesApi.ListDevices:output_type -> smartcore.bos.ListDevicesResponse
	5,  // 43: smartcore.bos.DevicesApi.PullDevices:output_type -> smartcore.bos.PullDevicesResponse
	1,  // 44: smartcore.bos.DevicesApi.GetDevicesMetadata:output_type -> smartcore.bos.DevicesMetadata
	8,  // 45: smartcore.bos.DevicesApi.PullDevicesMetadata:output_type -> smartcore.bos.PullDevicesMetadataResponse
	10, // 46: smartcore.bos.DevicesApi.GetDownloadDevicesUrl:output_type -> smartcore.bos.DownloadDevicesUrl
