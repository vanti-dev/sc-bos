...
func (c *colorApiClient) GetColor(ctx context.Context, in *GetColorRequest, opts ...grpc.CallOption) (*Color, error) {
	out := new(Color)
	err := c.cc.Invoke(ctx, ColorApi_GetColor_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *colorApiClient) UpdateColor(ctx context.Context, in *UpdateColorRequest, opts ...grpc.CallOption) (*Color, error) {
	out := new(Color)
	err := c.cc.Invoke(ctx, ColorApi_UpdateColor_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *colorApiClient) PullColor(ctx context.Context, in *PullColorRequest, opts ...grpc.CallOption) (ColorApi_PullColorClient, error) {
	stream, err := c.cc.NewStream(ctx, &ColorApi_ServiceDesc.Streams[0], ColorApi_PullColor_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *colorInfoClient) DescribeColor(ctx context.Context, in *DescribeColorRequest, opts ...grpc.CallOption) (*ColorSupport, error) {
	...
	err := c.cc.Invoke(ctx, ColorInfo_DescribeColor_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
