...
func file_button_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_button_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_button_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_button_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_button_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_button_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_button_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_button_proto_msgTypes[6].Exporter = func(v any, i int) any {
