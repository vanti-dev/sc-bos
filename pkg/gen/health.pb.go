...
type HealthCheck_Check_State int32

const (
	HealthCheck_Check_STATE_UNSPECIFIED HealthCheck_Check_State = 0
	// The value is within the normal operating range.
	// Any State greater than 1 indicates a problem with the device.
	HealthCheck_Check_NORMAL HealthCheck_Check_State = 1
	// The value is outside of the normal operating range.
	HealthCheck_Check_ABNORMAL HealthCheck_Check_State = 2
	// The value is below the normal operating range.
	HealthCheck_Check_LOW HealthCheck_Check_State = 3
	// The value is above the normal operating range.
	HealthCheck_Check_HIGH HealthCheck_Check_State = 4
)

// Enum value maps for HealthCheck_Check_State.
var (
	HealthCheck_Check_State_name = map[int32]string{
		0: "STATE_UNSPECIFIED",
		1: "NORMAL",
		2: "ABNORMAL",
		3: "LOW",
	...
	HealthCheck_Check_State_value = map[string]int32{
		"STATE_UNSPECIFIED": 0,
		"NORMAL":            1,
		"ABNORMAL":          2,
		"LOW":               3,
...
func (x HealthCheck_Check_State) Enum() *HealthCheck_Check_State {
	p := new(HealthCheck_Check_State)
	*p = x
	return p
}

func (x HealthCheck_Check_State) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (HealthCheck_Check_State) Descriptor() protoreflect.EnumDescriptor {
	return file_health_proto_enumTypes[4].Descriptor()
}

func (HealthCheck_Check_State) Type() protoreflect.EnumType {
	return &file_health_proto_enumTypes[4]
}

func (x HealthCheck_Check_State) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use HealthCheck_Check_State.Descriptor instead.
func (HealthCheck_Check_State) EnumDescriptor() ([]byte, []int) {
	return file_health_proto_rawDescGZIP(), []int{0, 5, 0}
}

// HealthCheck represents the results of a check against the health of a device.
type HealthCheck struct {
	...
	// A check that has been performed against the device.
	Check *HealthCheck_Check `protobuf:"bytes,11,opt,name=check,proto3" json:"check,omitempty"`
	// A bit mask of health state transitions that require acknowledgement.
	// See Ack for details.
	AckRequired *int32 `protobuf:"varint,20,opt,name=ack_required,json=ackRequired,proto3,oneof" json:"ack_required,omitempty"`
	// An acknowledgement for the change to a healthy state.
	// See Ack for details.
	ToHealthyAck *HealthCheck_Ack `protobuf:"bytes,21,opt,name=to_healthy_ack,json=toHealthyAck,proto3" json:"to_healthy_ack,omitempty"`
	// An acknowledgement for the change to a reliability state that is not RELIABLE.
	// See Ack for details.
	ToUnreliableAck *HealthCheck_Ack `protobuf:"bytes,22,opt,name=to_unreliable_ack,json=toUnreliableAck,proto3" json:"to_unreliable_ack,omitempty"`
	// An acknowledgement for the change to a check state that is not NORMAL.
	// See Ack for details.
	ToAbnormalAck *HealthCheck_Ack `protobuf:"bytes,23,opt,name=to_abnormal_ack,json=toAbnormalAck,proto3" json:"to_abnormal_ack,omitempty"`
...
func (x *HealthCheck) GetCheck() *HealthCheck_Check {
	if x != nil {
		return x.Check
	}
	return nil
...
// Error represents an error during one of the checks.
...
type HealthCheck_Reliability struct {
	...
	OkTime *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=ok_time,json=okTime,proto3" json:"ok_time,omitempty"`
...
func (x *HealthCheck_Reliability) GetOkTime() *timestamppb.Timestamp {
	if x != nil {
		return x.OkTime
	}
	return nil
...
type HealthCheck_ValueRange struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The low range, above which the value is considered normal.
	Low *HealthCheck_Value `protobuf:"bytes,1,opt,name=low,proto3" json:"low,omitempty"`
	// The high range, below which the value is considered normal.
	...
	//
	// When the check will transition from HIGH to NORMAL when the current_value becomes less than high - deadband,
...
// Check tracks a state value in the device for abnormality.
type HealthCheck_Check struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// The state of the check.
	State HealthCheck_Check_State `protobuf:"varint,1,opt,name=state,proto3,enum=smartcore.bos.HealthCheck_Check_State" json:"state,omitempty"`
	// The measured value.
	// Optional when state is not in a bad state.
	CurrentValue *HealthCheck_Value `protobuf:"bytes,3,opt,name=current_value,json=currentValue,proto3" json:"current_value,omitempty"`
	// Types that are valid to be assigned to Bounds:
	//
	//	*HealthCheck_Check_NormalValue
	//	*HealthCheck_Check_NormalRange
	//	*HealthCheck_Check_NormalValues
	//	*HealthCheck_Check_AbnormalValues
	Bounds isHealthCheck_Check_Bounds `protobuf_oneof:"bounds"`
	...
	// The time when the state last entered NORMAL.
	NormalTime *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=normal_time,json=normalTime,proto3" json:"normal_time,omitempty"`
	// The time when the device last entered a non-NORMAL state.
	AbnormalTime *timestamppb.Timestamp `protobuf:"bytes,10,opt,name=abnormal_time,json=abnormalTime,proto3" json:"abnormal_time,omitempty"`
	// An error message relating to the non-NORMAL state.
	LastError     *HealthCheck_Error `protobuf:"bytes,11,opt,name=last_error,json=lastError,proto3" json:"last_error,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *HealthCheck_Check) Reset() {
	*x = HealthCheck_Check{}
...
func (x *HealthCheck_Check) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HealthCheck_Check) ProtoMessage() {}

func (x *HealthCheck_Check) ProtoReflect() protoreflect.Message {
	mi := &file_health_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HealthCheck_Check.ProtoReflect.Descriptor instead.
func (*HealthCheck_Check) Descriptor() ([]byte, []int) {
	return file_health_proto_rawDescGZIP(), []int{0, 5}
}

func (x *HealthCheck_Check) GetState() HealthCheck_Check_State {
	if x != nil {
		return x.State
	}
	return HealthCheck_Check_STATE_UNSPECIFIED
}

func (x *HealthCheck_Check) GetCurrentValue() *HealthCheck_Value {
	if x != nil {
...
func (x *HealthCheck_Check) GetBounds() isHealthCheck_Check_Bounds {
	if x != nil {
		return x.Bounds
	}
	return nil
...
func (x *HealthCheck_Check) GetNormalValue() *HealthCheck_Value {
	if x != nil {
		if x, ok := x.Bounds.(*HealthCheck_Check_NormalValue); ok {
...
func (x *HealthCheck_Check) GetNormalRange() *HealthCheck_ValueRange {
	if x != nil {
		if x, ok := x.Bounds.(*HealthCheck_Check_NormalRange); ok {
...
func (x *HealthCheck_Check) GetNormalValues() *HealthCheck_Values {
	if x != nil {
		if x, ok := x.Bounds.(*HealthCheck_Check_NormalValues); ok {
...
func (x *HealthCheck_Check) GetAbnormalValues() *HealthCheck_Values {
	if x != nil {
		if x, ok := x.Bounds.(*HealthCheck_Check_AbnormalValues); ok {
...
func (x *HealthCheck_Check) GetDisplayUnit() string {
	if x != nil {
...
func (x *HealthCheck_Check) GetNormalTime() *timestamppb.Timestamp {
	if x != nil {
		return x.NormalTime
	}
	return nil
...
func (x *HealthCheck_Check) GetAbnormalTime() *timestamppb.Timestamp {
	if x != nil {
...
func (x *HealthCheck_Check) GetLastError() *HealthCheck_Error {
	if x != nil {
		return x.LastError
	}
	return nil
...
type isHealthCheck_Check_Bounds interface {
	isHealthCheck_Check_Bounds()
}

type HealthCheck_Check_NormalValue struct {
	...
	NormalValue *HealthCheck_Value `protobuf:"bytes,4,opt,name=normal_value,json=normalValue,proto3,oneof"`
}

type HealthCheck_Check_NormalRange struct {
	...
	NormalRange *HealthCheck_ValueRange `protobuf:"bytes,5,opt,name=normal_range,json=normalRange,proto3,oneof"`
}

type HealthCheck_Check_NormalValues struct {
...
type HealthCheck_Check_AbnormalValues struct {
...
func (*HealthCheck_Check_NormalValue) isHealthCheck_Check_Bounds() {}

func (*HealthCheck_Check_NormalRange) isHealthCheck_Check_Bounds() {}

func (*HealthCheck_Check_NormalValues) isHealthCheck_Check_Bounds() {}

func (*HealthCheck_Check_AbnormalValues) isHealthCheck_Check_Bounds() {}
...
//
// Each check can specify whether it requires an acknowledgement independently for each health state transition.
// The possible transitions are represented by the HealthChange enum.
// Changing the required acks will not change any existing acks, but will change the required acks for future changes
// in health state.
//
...
func (*HealthCheck_Reliability_Affects) Descriptor() ([]byte, []int) {
	return file_health_proto_rawDescGZIP(), []int{0, 1, 1}
}
...
func (*PullHealthCheckResponse_Change) Descriptor() ([]byte, []int) {
	return file_health_proto_rawDescGZIP(), []int{7, 0}
}
...
const file_health_proto_rawDesc = "" +
	"\n" +
	"\fhealth.proto\x12\rsmartcore.bos\x1a\x1egoogle/protobuf/duration.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\vactor.proto\x1a\x12types/change.proto\"\xc0\x1a\n" +
	...
	"\x10equipment_impact\x18\x06 \x01(\x0e2*.smartcore.bos.HealthCheck.EquipmentImpactR\x0fequipmentImpact\x12H\n" +
	"\vreliability\x18\n" +
	" \x01(\v2&.smartcore.bos.HealthCheck.ReliabilityR\vreliability\x126\n" +
	"\x05check\x18\v \x01(\v2 .smartcore.bos.HealthCheck.CheckR\x05check\x12&\n" +
	"\fack_required\x18\x14 \x01(\x05H\x00R\vackRequired\x88\x01\x01\x12D\n" +
	"\x0eto_healthy_ack\x18\x15 \x01(\v2\x1e.smartcore.bos.HealthCheck.AckR\ftoHealthyAck\x12J\n" +
	"\x11to_unreliable_ack\x18\x16 \x01(\v2\x1e.smartcore.bos.HealthCheck.AckR\x0ftoUnreliableAck\x12F\n" +
	"\x0fto_abnormal_ack\x18\x17 \x01(\v2\x1e.smartcore.bos.HealthCheck.AckR\rtoAbnormalAck\x1a\xbc\x01\n" +
	"\x05Error\x12!\n" +
	...
	"\x06system\x18\x02 \x01(\tR\x06system\x1a\xe9\x05\n" +
	"\vReliability\x12B\n" +
	"\x05state\x18\x01 \x01(\x0e2,.smartcore.bos.HealthCheck.Reliability.StateR\x05state\x123\n" +
	"\aok_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\x06okTime\x12C\n" +
	...
	"\x06Values\x128\n" +
	"\x06values\x18\x01 \x03(\v2 .smartcore.bos.HealthCheck.ValueR\x06values\x1a\xf0\x05\n" +
	"\x05Check\x12<\n" +
	"\x05state\x18\x01 \x01(\x0e2&.smartcore.bos.HealthCheck.Check.StateR\x05state\x12E\n" +
	"\rcurrent_value\x18\x03 \x01(\v2 .smartcore.bos.HealthCheck.ValueR\fcurrentValue\x12E\n" +
	"\fnormal_value\x18\x04 \x01(\v2 .smartcore.bos.HealthCheck.ValueH\x00R\vnormalValue\x12J\n" +
	"\fnormal_range\x18\x05 \x01(\v2%.smartcore.bos.HealthCheck.ValueRangeH\x00R\vnormalRange\x12H\n" +
	...
	"\fdisplay_unit\x18\b \x01(\tR\vdisplayUnit\x12;\n" +
	"\vnormal_time\x18\t \x01(\v2\x1a.google.protobuf.TimestampR\n" +
	"normalTime\x12?\n" +
	"\rabnormal_time\x18\n" +
	" \x01(\v2\x1a.google.protobuf.TimestampR\fabnormalTime\x12?\n" +
	"\n" +
	"last_error\x18\v \x01(\v2 .smartcore.bos.HealthCheck.ErrorR\tlastError\"K\n" +
	"\x05State\x12\x15\n" +
	...
	"\vTO_ABNORMAL\x10\x04B\x0f\n" +
	"\r_ack_required\"\xa2\x01\n" +
	...
	"\x0fPullHealthCheck\x12%.smartcore.bos.PullHealthCheckRequest\x1a&.smartcore.bos.PullHealthCheckResponse0\x01B%Z#github.com/vanti-dev/sc-bos/pkg/genb\x06proto3"
...
var file_health_proto_goTypes = []any{
	...
	(HealthCheck_HealthChange)(0),           // 2: smartcore.bos.HealthCheck.HealthChange
	(HealthCheck_Reliability_State)(0),      // 3: smartcore.bos.HealthCheck.Reliability.State
	(HealthCheck_Check_State)(0),            // 4: smartcore.bos.HealthCheck.Check.State
	...
	(*HealthCheck_Error)(nil),               // 13: smartcore.bos.HealthCheck.Error
	(*HealthCheck_Reliability)(nil),         // 14: smartcore.bos.HealthCheck.Reliability
	(*HealthCheck_Value)(nil),               // 15: smartcore.bos.HealthCheck.Value
	(*HealthCheck_ValueRange)(nil),          // 16: smartcore.bos.HealthCheck.ValueRange
	(*HealthCheck_Values)(nil),              // 17: smartcore.bos.HealthCheck.Values
	(*HealthCheck_Check)(nil),               // 18: smartcore.bos.HealthCheck.Check
	(*HealthCheck_Ack)(nil),                 // 19: smartcore.bos.HealthCheck.Ack
	(*HealthCheck_Error_Code)(nil),          // 20: smartcore.bos.HealthCheck.Error.Code
	(*HealthCheck_Reliability_Cause)(nil),   // 21: smartcore.bos.HealthCheck.Reliability.Cause
	(*HealthCheck_Reliability_Affects)(nil), // 22: smartcore.bos.HealthCheck.Reliability.Affects
	(*PullHealthChecksResponse_Change)(nil), // 23: smartcore.bos.PullHealthChecksResponse.Change
	(*PullHealthCheckResponse_Change)(nil),  // 24: smartcore.bos.PullHealthCheckResponse.Change
	(*fieldmaskpb.FieldMask)(nil),           // 25: google.protobuf.FieldMask
	(*timestamppb.Timestamp)(nil),           // 26: google.protobuf.Timestamp
	(*durationpb.Duration)(nil),             // 27: google.protobuf.Duration
	(*Actor)(nil),                           // 28: smartcore.bos.Actor
...
var file_health_proto_depIdxs = []int32{
	...
	14, // 2: smartcore.bos.HealthCheck.reliability:type_name -> smartcore.bos.HealthCheck.Reliability
	18, // 3: smartcore.bos.HealthCheck.check:type_name -> smartcore.bos.HealthCheck.Check
	19, // 4: smartcore.bos.HealthCheck.to_healthy_ack:type_name -> smartcore.bos.HealthCheck.Ack
	19, // 5: smartcore.bos.HealthCheck.to_unreliable_ack:type_name -> smartcore.bos.HealthCheck.Ack
	19, // 6: smartcore.bos.HealthCheck.to_abnormal_ack:type_name -> smartcore.bos.HealthCheck.Ack
	25, // 7: smartcore.bos.ListHealthChecksRequest.read_mask:type_name -> google.protobuf.FieldMask
	5,  // 8: smartcore.bos.ListHealthChecksResponse.health_checks:type_name -> smartcore.bos.HealthCheck
	25, // 9: smartcore.bos.PullHealthChecksRequest.read_mask:type_name -> google.protobuf.FieldMask
	23, // 10: smartcore.bos.PullHealthChecksResponse.changes:type_name -> smartcore.bos.PullHealthChecksResponse.Change
	25, // 11: smartcore.bos.GetHealthCheckRequest.read_mask:type_name -> google.protobuf.FieldMask
	25, // 12: smartcore.bos.PullHealthCheckRequest.read_mask:type_name -> google.protobuf.FieldMask
	24, // 13: smartcore.bos.PullHealthCheckResponse.changes:type_name -> smartcore.bos.PullHealthCheckResponse.Change
	20, // 14: smartcore.bos.HealthCheck.Error.code:type_name -> smartcore.bos.HealthCheck.Error.Code
	3,  // 15: smartcore.bos.HealthCheck.Reliability.state:type_name -> smartcore.bos.HealthCheck.Reliability.State
	26, // 16: smartcore.bos.HealthCheck.Reliability.ok_time:type_name -> google.protobuf.Timestamp
	26, // 17: smartcore.bos.HealthCheck.Reliability.unreliable_time:type_name -> google.protobuf.Timestamp
	13, // 18: smartcore.bos.HealthCheck.Reliability.last_error:type_name -> smartcore.bos.HealthCheck.Error
	21, // 19: smartcore.bos.HealthCheck.Reliability.cause:type_name -> smartcore.bos.HealthCheck.Reliability.Cause
	22, // 20: smartcore.bos.HealthCheck.Reliability.affects:type_name -> smartcore.bos.HealthCheck.Reliability.Affects
	26, // 21: smartcore.bos.HealthCheck.Value.timestamp_value:type_name -> google.protobuf.Timestamp
	27, // 22: smartcore.bos.HealthCheck.Value.duration_value:type_name -> google.protobuf.Duration
	15, // 23: smartcore.bos.HealthCheck.ValueRange.low:type_name -> smartcore.bos.HealthCheck.Value
	15, // 24: smartcore.bos.HealthCheck.ValueRange.high:type_name -> smartcore.bos.HealthCheck.Value
	15, // 25: smartcore.bos.HealthCheck.ValueRange.deadband:type_name -> smartcore.bos.HealthCheck.Value
	15, // 26: smartcore.bos.HealthCheck.Values.values:type_name -> smartcore.bos.HealthCheck.Value
	4,  // 27: smartcore.bos.HealthCheck.Check.state:type_name -> smartcore.bos.HealthCheck.Check.State
	15, // 28: smartcore.bos.HealthCheck.Check.current_value:type_name -> smartcore.bos.HealthCheck.Value
	15, // 29: smartcore.bos.HealthCheck.Check.normal_value:type_name -> smartcore.bos.HealthCheck.Value
	16, // 30: smartcore.bos.HealthCheck.Check.normal_range:type_name -> smartcore.bos.HealthCheck.ValueRange
	17, // 31: smartcore.bos.HealthCheck.Check.normal_values:type_name -> smartcore.bos.HealthCheck.Values
	17, // 32: smartcore.bos.HealthCheck.Check.abnormal_values:type_name -> smartcore.bos.HealthCheck.Values
	26, // 33: smartcore.bos.HealthCheck.Check.normal_time:type_name -> google.protobuf.Timestamp
	26, // 34: smartcore.bos.HealthCheck.Check.abnormal_time:type_name -> google.protobuf.Timestamp
	13, // 35: smartcore.bos.HealthCheck.Check.last_error:type_name -> smartcore.bos.HealthCheck.Error
	26, // 36: smartcore.bos.HealthCheck.Ack.ack_time:type_name -> google.protobuf.Timestamp
	28, // 37: smartcore.bos.HealthCheck.Ack.actor:type_name -> smartcore.bos.Actor
	13, // 38: smartcore.bos.HealthCheck.Reliability.Cause.error:type_name -> smartcore.bos.HealthCheck.Error
	29, // 39: smartcore.bos.PullHealthChecksResponse.Change.type:type_name -> smartcore.types.ChangeType
	5,  // 40: smartcore.bos.PullHealthChecksResponse.Change.new_value:type_name -> smartcore.bos.HealthCheck
	5,  // 41: smartcore.bos.PullHealthChecksResponse.Change.old_value:type_name -> smartcore.bos.HealthCheck
	26, // 42: smartcore.bos.PullHealthChecksResponse.Change.change_time:type_name -> google.protobuf.Timestamp
	5,  // 43: smartcore.bos.PullHealthCheckResponse.Change.health_check:type_name -> smartcore.bos.HealthCheck
	26, // 44: smartcore.bos.PullHealthCheckResponse.Change.change_time:type_name -> google.protobuf.Timestamp
	6,  // 45: smartcore.bos.HealthApi.ListHealthChecks:input_type -> smartcore.bos.ListHealthChecksRequest
	8,  // 46: smartcore.bos.HealthApi.PullHealthChecks:input_type -> smartcore.bos.PullHealthChecksRequest
	10, // 47: smartcore.bos.HealthApi.GetHealthCheck:input_type -> smartcore.bos.GetHealthCheckRequest
	11, // 48: smartcore.bos.HealthApi.PullHealthCheck:input_type -> smartcore.bos.PullHealthCheckRequest
	7,  // 49: smartcore.bos.HealthApi.ListHealthChecks:output_type -> smartcore.bos.ListHealthChecksResponse
	9,  // 50: smartcore.bos.HealthApi.PullHealthChecks:output_type -> smartcore.bos.PullHealthChecksResponse
	5,  // 51: smartcore.bos.HealthApi.GetHealthCheck:output_type -> smartcore.bos.HealthCheck
	12, // 52: smartcore.bos.HealthApi.PullHealthCheck:output_type -> smartcore.bos.PullHealthCheckResponse
...
func file_health_proto_init() {
	...
	file_health_proto_msgTypes[10].OneofWrappers = []any{
	...
	file_health_proto_msgTypes[13].OneofWrappers = []any{
		(*HealthCheck_Check_NormalValue)(nil),
		(*HealthCheck_Check_NormalRange)(nil),
		(*HealthCheck_Check_NormalValues)(nil),
		(*HealthCheck_Check_AbnormalValues)(nil),
	}
	type x struct{}
