...
const file_health_proto_rawDesc = "" +
	"\n" +
	"\fhealth.proto\x12\rsmartcore.bos\x1a\x1egoogle/protobuf/duration.proto\x1a google/protobuf/field_mask.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a\x12types/change.proto\"\xc0\x1c\n" +
	...
	"\x06faults\x18\x10 \x01(\v2!.smartcore.bos.HealthCheck.FaultsH\x00R\x06faults\x1a\xc7\x03\n" +
...
var file_health_proto_depIdxs = []int32{
	...
	13, // 2: smartcore.bos.HealthCheck.compliance_impacts:type_name -> smartcore.bos.HealthCheck.ComplianceImpact
	15, // 3: smartcore.bos.HealthCheck.reliability:type_name -> smartcore.bos.HealthCheck.Reliability
	2,  // 4: smartcore.bos.HealthCheck.normality:type_name -> smartcore.bos.HealthCheck.Normality
	27, // 5: smartcore.bos.HealthCheck.normal_time:type_name -> google.protobuf.Timestamp
	27, // 6: smartcore.bos.HealthCheck.abnormal_time:type_name -> google.protobuf.Timestamp
	19, // 7: smartcore.bos.HealthCheck.bounds:type_name -> smartcore.bos.HealthCheck.Bounds
	20, // 8: smartcore.bos.HealthCheck.faults:type_name -> smartcore.bos.HealthCheck.Faults
	28, // 9: smartcore.bos.ListHealthChecksRequest.read_mask:type_name -> google.protobuf.FieldMask
	5,  // 10: smartcore.bos.ListHealthChecksResponse.health_checks:type_name -> smartcore.bos.HealthCheck
	28, // 11: smartcore.bos.PullHealthChecksRequest.read_mask:type_name -> google.protobuf.FieldMask
	25, // 12: smartcore.bos.PullHealthChecksResponse.changes:type_name -> smartcore.bos.PullHealthChecksResponse.Change
	28, // 13: smartcore.bos.GetHealthCheckRequest.read_mask:type_name -> google.protobuf.FieldMask
	28, // 14: smartcore.bos.PullHealthCheckRequest.read_mask:type_name -> google.protobuf.FieldMask
	26, // 15: smartcore.bos.PullHealthCheckResponse.changes:type_name -> smartcore.bos.PullHealthCheckResponse.Change
	21, // 16: smartcore.bos.HealthCheck.ComplianceImpact.standard:type_name -> smartcore.bos.HealthCheck.ComplianceImpact.Standard
	3,  // 17: smartcore.bos.HealthCheck.ComplianceImpact.contribution:type_name -> smartcore.bos.HealthCheck.ComplianceImpact.Contribution
	22, // 18: smartcore.bos.HealthCheck.Error.code:type_name -> smartcore.bos.HealthCheck.Error.Code
	4,  // 19: smartcore.bos.HealthCheck.Reliability.state:type_name -> smartcore.bos.HealthCheck.Reliability.State
	27, // 20: smartcore.bos.HealthCheck.Reliability.reliable_time:type_name -> google.protobuf.Timestamp
	27, // 21: smartcore.bos.HealthCheck.Reliability.unreliable_time:type_name -> google.protobuf.Timestamp
	14, // 22: smartcore.bos.HealthCheck.Reliability.last_error:type_name -> smartcore.bos.HealthCheck.Error
	23, // 23: smartcore.bos.HealthCheck.Reliability.cause:type_name -> smartcore.bos.HealthCheck.Reliability.Cause
	24, // 24: smartcore.bos.HealthCheck.Reliability.affects:type_name -> smartcore.bos.HealthCheck.Reliability.Affects
	27, // 25: smartcore.bos.HealthCheck.Value.timestamp_value:type_name -> google.protobuf.Timestamp
	29, // 26: smartcore.bos.HealthCheck.Value.duration_value:type_name -> google.protobuf.Duration
	16, // 27: smartcore.bos.HealthCheck.ValueRange.low:type_name -> smartcore.bos.HealthCheck.Value
	16, // 28: smartcore.bos.HealthCheck.ValueRange.high:type_name -> smartcore.bos.HealthCheck.Value
	16, // 29: smartcore.bos.HealthCheck.ValueRange.deadband:type_name -> smartcore.bos.HealthCheck.Value
	16, // 30: smartcore.bos.HealthCheck.Values.values:type_name -> smartcore.bos.HealthCheck.Value
	16, // 31: smartcore.bos.HealthCheck.Bounds.current_value:type_name -> smartcore.bos.HealthCheck.Value
	16, // 32: smartcore.bos.HealthCheck.Bounds.normal_value:type_name -> smartcore.bos.HealthCheck.Value
	16, // 33: smartcore.bos.HealthCheck.Bounds.abnormal_value:type_name -> smartcore.bos.HealthCheck.Value
	17, // 34: smartcore.bos.HealthCheck.Bounds.normal_range:type_name -> smartcore.bos.HealthCheck.ValueRange
	18, // 35: smartcore.bos.HealthCheck.Bounds.normal_values:type_name -> smartcore.bos.HealthCheck.Values
	18, // 36: smartcore.bos.HealthCheck.Bounds.abnormal_values:type_name -> smartcore.bos.HealthCheck.Values
	14, // 37: smartcore.bos.HealthCheck.Faults.current_faults:type_name -> smartcore.bos.HealthCheck.Error
	14, // 38: smartcore.bos.HealthCheck.Reliability.Cause.error:type_name -> smartcore.bos.HealthCheck.Error
	30, // 39: smartcore.bos.PullHealthChecksResponse.Change.type:type_name -> smartcore.types.ChangeType
	...
	27, // 42: smartcore.bos.PullHealthChecksResponse.Change.change_time:type_name -> google.protobuf.Timestamp
	5,  // 43: smartcore.bos.PullHealthCheckResponse.Change.health_check:type_name -> smartcore.bos.HealthCheck
	27, // 44: smartcore.bos.PullHealthCheckResponse.Change.change_time:type_name -> google.protobuf.Timestamp
