...
type HealthCheck_Reliability struct {
	...
	// Effects should be set when this device has an impact on the reliability of other devices,
	// even if information about the affected devices is not available.
	Effects       *HealthCheck_Reliability_Effects `protobuf:"bytes,6,opt,name=effects,proto3" json:"effects,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *HealthCheck_Reliability) GetEffects() *HealthCheck_Reliability_Effects {
	if x != nil {
		return x.Effects
	}
	return nil
...
// Effects represents the impact this device has on the reliability of other devices.
// An empty Effects denotes that this device affects other devices, but no other information is available.
type HealthCheck_Reliability_Effects struct {
	state protoimpl.MessageState `protogen:"open.v1"`
...
func (x *HealthCheck_Reliability_Effects) Reset() {
	*x = HealthCheck_Reliability_Effects{}
	mi := &file_health_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *HealthCheck_Reliability_Effects) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HealthCheck_Reliability_Effects) ProtoMessage() {}

func (x *HealthCheck_Reliability_Effects) ProtoReflect() protoreflect.Message {
	mi := &file_health_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HealthCheck_Reliability_Effects.ProtoReflect.Descriptor instead.
func (*HealthCheck_Reliability_Effects) Descriptor() ([]byte, []int) {
	return file_health_proto_rawDescGZIP(), []int{0, 2, 1}
}

func (x *HealthCheck_Reliability_Effects) GetCount() int32 {
	if x != nil {
		return x.Count
	}
	return 0
...
const file_health_proto_rawDesc = "" +
	...
	"\aeffects\x18\x06 \x01(\v2..smartcore.bos.HealthCheck.Reliability.EffectsR\aeffects\x1av\n" +
	"\x05Cause\x12\x12\n" +
...
var file_health_proto_goTypes = []any{
	...
	(*HealthCheck_Reliability_Effects)(nil),        // 28: smartcore.bos.HealthCheck.Reliability.Effects
...
var file_health_proto_depIdxs = []int32{
	...
	28, // 31: smartcore.bos.HealthCheck.Reliability.effects:type_name -> smartcore.bos.HealthCheck.Reliability.Effects
