...
type GetWasteRecordsRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetWasteRecordsRequest) Reset() {
	*x = GetWasteRecordsRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetWasteRecordsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetWasteRecordsRequest) ProtoMessage() {}

func (x *GetWasteRecordsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_waste_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetWasteRecordsRequest.ProtoReflect.Descriptor instead.
func (*GetWasteRecordsRequest) Descriptor() ([]byte, []int) {
	return file_waste_proto_rawDescGZIP(), []int{2}
}

func (x *GetWasteRecordsRequest) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *GetWasteRecordsRequest) GetReadMask() *fieldmaskpb.FieldMask {
	if x != nil {
		return x.ReadMask
	}
	return nil
...
var file_waste_proto_rawDesc = []byte{
	...
	0x28, 0x05, 0x52, 0x09, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x53, 0x69, 0x7a, 0x65, 0x22, 0x65, 0x0a,
	0x16, 0x47, 0x65, 0x74, 0x57, 0x61, 0x73, 0x74, 0x65, 0x52, 0x65, 0x63, 0x6f, 0x72, 0x64, 0x73,
	...
	0x4d, 0x61, 0x73, 0x6b, 0x22, 0x89, 0x01, 0x0a, 0x17, 0x50, 0x75, 0x6c, 0x6c, 0x57, 0x61, 0x73,
	...
	0x22, 0xbf, 0x01, 0x0a, 0x18, 0x50, 0x75, 0x6c, 0x6c, 0x57, 0x61, 0x73, 0x74, 0x65, 0x52, 0x65,
	...
	0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x1a, 0x59, 0x0a, 0x06, 0x43, 0x68, 0x61, 0x6e, 0x67,
	...
	,
...
var file_waste_proto_goTypes = []any{
	...
	(*GetWasteRecordsRequest)(nil),          // 2: smartcore.bos.GetWasteRecordsRequest
...
var file_waste_proto_depIdxs = []int32{
	...
	7, // 3: smartcore.bos.GetWasteRecordsRequest.read_mask:type_name -> google.protobuf.FieldMask
	...
	2, // 7: smartcore.bos.WasteApi.ListWasteRecords:input_type -> smartcore.bos.GetWasteRecordsRequest
...
func file_waste_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_waste_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*GetWasteRecordsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
