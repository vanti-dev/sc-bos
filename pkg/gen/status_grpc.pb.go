...
func (c *statusApiClient) GetCurrentStatus(ctx context.Context, in *GetCurrentStatusRequest, opts ...grpc.CallOption) (*StatusLog, error) {
	out := new(StatusLog)
	err := c.cc.Invoke(ctx, StatusApi_GetCurrentStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *statusApiClient) PullCurrentStatus(ctx context.Context, in *PullCurrentStatusRequest, opts ...grpc.CallOption) (StatusApi_PullCurrentStatusClient, error) {
	stream, err := c.cc.NewStream(ctx, &StatusApi_ServiceDesc.Streams[0], StatusApi_PullCurrentStatus_FullMethodName, opts...)
	if err != nil {
		return nil, err
	}
...
func (c *statusHistoryClient) ListCurrentStatusHistory(ctx context.Context, in *ListCurrentStatusHistoryRequest, opts ...grpc.CallOption) (*ListCurrentStatusHistoryResponse, error) {
	...
	err := c.cc.Invoke(ctx, StatusHistory_ListCurrentStatusHistory_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
