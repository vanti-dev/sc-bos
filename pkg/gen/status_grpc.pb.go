...
const (
	...
	StatusApi_UpdateCurrentStatus_FullMethodName = "/smartcore.bos.StatusApi/UpdateCurrentStatus"
)
...
type StatusApiClient interface {
	...
	UpdateCurrentStatus(ctx context.Context, in *UpdateCurrentStatusRequest, opts ...grpc.CallOption) (*UpdateCurrentStatusResponse, error)
}
...
func (c *statusApiClient) UpdateCurrentStatus(ctx context.Context, in *UpdateCurrentStatusRequest, opts ...grpc.CallOption) (*UpdateCurrentStatusResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpdateCurrentStatusResponse)
	err := c.cc.Invoke(ctx, StatusApi_UpdateCurrentStatus_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type StatusApiServer interface {
	...
	UpdateCurrentStatus(context.Context, *UpdateCurrentStatusRequest) (*UpdateCurrentStatusResponse, error)
...
func (UnimplementedStatusApiServer) UpdateCurrentStatus(context.Context, *UpdateCurrentStatusRequest) (*UpdateCurrentStatusResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method UpdateCurrentStatus not implemented")
}
...
func _StatusApi_UpdateCurrentStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpdateCurrentStatusRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(StatusApiServer).UpdateCurrentStatus(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: StatusApi_UpdateCurrentStatus_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(StatusApiServer).UpdateCurrentStatus(ctx, req.(*UpdateCurrentStatusRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var StatusApi_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "UpdateCurrentStatus",
			Handler:    _StatusApi_UpdateCurrentStatus_Handler,
		},
	},
