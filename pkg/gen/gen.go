...
//go:generate protomod protoc -- -I ../../proto --go_out=paths=source_relative:. --go-grpc_out=paths=source_relative:. --router_out=../.. --wrapper_out=../.. alerts.proto button.proto history.proto meter.proto mqtt.proto services.proto udmi.proto
