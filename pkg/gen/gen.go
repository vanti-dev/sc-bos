...
//go:generate protomod protoc -- -I ../../proto --go_out=paths=source_relative:. --go-grpc_out=paths=source_relative:. --router_out=../.. --wrapper_out=../.. alerts.proto axiomxa.proto dali.proto history.proto mqtt.proto services.proto status.proto udmi.proto
