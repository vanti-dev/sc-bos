...
//go:generate protoc -I ../../proto --go_out=paths=source_relative:. --go-grpc_out=paths=source_relative:. enrollment.proto lighting_test.proto priority.proto
...
//go:generate protomod protoc -- -I ../../proto --go_out=paths=source_relative:. --go-grpc_out=paths=source_relative:. --router_out=../.. --wrapper_out=../.. access.proto alerts.proto axiomxa.proto button.proto color.proto dali.proto history.proto meter.proto mqtt.proto services.proto status.proto temperature.proto udmi.proto
