...
//go:generate protoc -I ../../proto --go_out=paths=source_relative:. --go-grpc_out=paths=source_relative:. enrollment.proto
...
//go:generate protomod protoc -- -I ../../proto --go_out=paths=source_relative:. --go-grpc_out=paths=source_relative:. --router_out=../.. --wrapper_out=../.. account.proto actor.proto access.proto alerts.proto anpr_camera.proto axiomxa.proto button.proto dali.proto emergency_light.proto history.proto meter.proto mqtt.proto report.proto security_event.proto services.proto service_ticket.proto sound_sensor.proto status.proto temperature.proto transport.proto udmi.proto
//go:generate protomod protoc -- -I ../../proto --go_out=paths=source_relative:. --go-grpc_out=paths=source_relative:. --wrapper_out=../.. devices.proto hub.proto tenants.proto
