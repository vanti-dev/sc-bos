...
//go:generate protomod protoc -- -I ../../proto --go_out=paths=source_relative:. --go-grpc_out=paths=source_relative:. --router_out=../.. --wrapper_out=../.. account.proto actor.proto access.proto alerts.proto axiomxa.proto button.proto dali.proto history.proto meter.proto mqtt.proto security_event.proto services.proto status.proto temperature.proto transport.proto udmi.proto
