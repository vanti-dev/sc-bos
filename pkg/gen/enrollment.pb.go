...
type Enrollment struct {
	...
	// An X.509 certificate issued by the management node to the target node, in DER-encoded ASN.1 format.
	//The certificate MUST NOT be wrapped in a PEM container.
	//
	//The certificate MUST be signed by the one of the Certificate Authorities whose certificate is present in root_cas,
	//and it MUST be signed for the same public key as the target node's self-signed TLS certificate.
	//
	//The certificate's Subject Common Name SHOULD be a human-readable name for the target node.
	//The certificate MUST contain target_name as a URI Subject Alternative Name in the form "smart-core:<target_name>"
	//If the enrollment connection was opened by resolving a DNS name, then the certificate MUST contain that DNS name as a
	//Subject Alternative Name.
	//If the enrollment connection was opened by directly connecting to an IP address, then the certificate MUST contain
	//that IP address as a Subject Alternative Name.
	Certificate []byte `protobuf:"bytes,4,opt,name=certificate,proto3" json:"certificate,omitempty"`
	// One or more X.509 certificates, in DER-encoded ASN.1 format.
	//
	...
	//The certificates MUST NOT be wrapped in a PEM container.
	RootCas [][]byte `protobuf:"bytes,5,rep,name=root_cas,json=rootCas,proto3" json:"root_cas,omitempty"`
}
...
var file_enrollment_proto_rawDesc = []byte{
	...
	0x22, 0xb6, 0x01, 0x0a, 0x0a, 0x45, 0x6e, 0x72, 0x6f, 0x6c, 0x6c, 0x6d, 0x65, 0x6e, 0x74, 0x12,
	...
	,
	...
	0x6e, 0x72, 0x6f, 0x6c, 0x6c, 0x6d, 0x65, 0x6e, 0x74, 0x22, 0x00, 0x12, 0x55, 0x0a, 0x10, 0x44,
	0x65, 0x6c, 0x65, 0x74, 0x65, 0x45, 0x6e, 0x72, 0x6f, 0x6c, 0x6c, 0x6d, 0x65, 0x6e, 0x74, 0x12,
	0x25, 0x2e, 0x76, 0x61, 0x6e, 0x74, 0x69, 0x2e, 0x62, 0x73, 0x70, 0x2e, 0x65, 0x77, 0x2e, 0x44,
	0x65, 0x6c, 0x65, 0x74, 0x65, 0x45, 0x6e, 0x72, 0x6f, 0x6c, 0x6c, 0x6d, 0x65, 0x6e, 0x74, 0x52,
