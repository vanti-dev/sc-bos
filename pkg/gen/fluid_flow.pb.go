...
// FluidFlow Direction describes the control of fluid flow, is returning the fluid passed through or is blocking the flow.
...
type FluidFlow struct {
	...
	// The target drive frequency set at the device e.g. Hz
