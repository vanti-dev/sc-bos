...
type TenantApiClient interface {
	...
	GetSecretByHash(ctx context.Context, in *GetSecretByHashRequest, opts ...grpc.CallOption) (*Secret, error)
...
func (c *tenantApiClient) GetSecretByHash(ctx context.Context, in *GetSecretByHashRequest, opts ...grpc.CallOption) (*Secret, error) {
	out := new(Secret)
	err := c.cc.Invoke(ctx, "/vanti.bsp.ew.tenants.TenantApi/GetSecretByHash", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TenantApiServer interface {
	...
	GetSecretByHash(context.Context, *GetSecretByHashRequest) (*Secret, error)
...
func (UnimplementedTenantApiServer) GetSecretByHash(context.Context, *GetSecretByHashRequest) (*Secret, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetSecretByHash not implemented")
}
...
func _TenantApi_GetSecretByHash_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetSecretByHashRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TenantApiServer).GetSecretByHash(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/vanti.bsp.ew.tenants.TenantApi/GetSecretByHash",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TenantApiServer).GetSecretByHash(ctx, req.(*GetSecretByHashRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TenantApi_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetSecretByHash",
			Handler:    _TenantApi_GetSecretByHash_Handler,
		},
		{
