...
require (
	...
	github.com/vanti-dev/sc-bos v0.2024.6-0.20241001133502-1ec45ddfd1c0
...
require (
	...
	github.com/vanti-dev/gobacnet v0.0.0-20231102122752-32b0b38bcc53 // indirect
