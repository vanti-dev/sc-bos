...
import DeleteSecretDialog from '@/routes/auth/tenant/DeleteSecretDialog.vue';
import NewSecretForm from '@/routes/auth/tenant/NewSecretForm.vue';
import SecretListItem from '@/routes/auth/tenant/SecretListItem.vue';
import SecretTokenListItem from '@/routes/auth/tenant/SecretTokenListItem.vue';
