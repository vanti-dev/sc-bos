 ...
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.smartcore.bos.EmergencyLight)}
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.smartcore.bos.ListEmergencyLightsResponse)}
 *     callback The callback function(error, response)
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.RpcError, ?proto.smartcore.bos.ListEmergencyLightEventsResponse)}
 *     callback The callback function(error, response)
