<template>
  <v-btn-group class="menu-btn">
    <v-btn v-bind="{...dlBtnProps, ...dlBtnLinkProps}" :disabled="!!dlBtnDisabled" v-tooltip:bottom="dlBtnTooltip">
        ...
        <v-card width="380px">
          ...
          <v-card-actions>
            <div v-tooltip:bottom="dlBtnTooltip" style="min-width: 100%">
              <v-btn block color="primary" variant="flat" v-bind="dlBtnLinkProps" :disabled="!!dlBtnDisabled">
...
import {DAY, HOUR, MINUTE, useNow} from '@/components/now.js';
