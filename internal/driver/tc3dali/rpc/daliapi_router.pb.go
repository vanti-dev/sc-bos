...
// DaliApiRouter is a rpc.DaliApiServer that allows routing named requests to specific rpc.DaliApiClient
...
// Add extends Router.Add to panic if client is not of type rpc.DaliApiClient.
func (r *DaliApiRouter) Add(name string, client interface{}) interface{} {
	if !r.HoldsType(client) {
		panic(fmt.Sprintf("not correct type: client of type %T is not a rpc.DaliApiClient", client))
	}
	return r.Router.Add(name, client)
}

func (r *DaliApiRouter) HoldsType(client interface{}) bool {
